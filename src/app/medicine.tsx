...
const getStyles = (C: any) => StyleSheet.create({
  ...
  productImg: { width: 52, height: 52, borderRadius: 14, backgroundColor: 'rgba(255,255,255,0.05)', alignItems: 'center', justifyContent: 'center' },
  ...
  rxText: { color: '#FF8A94', fontSize: RF(9), fontWeight: '800' },
  productPrice: { fontSize: RF(16), fontWeight: '800', color: '#fff', marginTop: 6 },
